...
if __name__ == "__main__":
    ...
    parser.add_argument('--seq_len', help = "The amount of charachters fed into the network in a single step. Backprogation through time is limited for 1 full sequence. Default:256", default = 256)
    parser.add_argument('--num_layers', help = "The number of stacked LSTM-layers. Default=2", default = 2)
    parser.add_argument('--hidden_size', help = "Number of dimensions of the hidden state vector (LSTM). Default=256", default = 256)
    parser.add_argument('--dropout', help = "Percantage of dropout used for training. Default=0.2", default = 0.2)
    ...
    model = LSTM(input_size=input_size, hidden_size=args.hidden_size, num_layers=args.num_layers, dropout=args.dropout)
